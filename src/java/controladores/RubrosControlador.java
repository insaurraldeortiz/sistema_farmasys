...
public class RubrosControlador {
    public static boolean agregar(Rubros rubro){
        ...
        if (Conexion.conectar()){
            String sql = "insert into rubros (nombre_rubro)" 
                    + "values ('" + rubro.getNombre_rubro() + "')";
            ...
            try {
                ...
                Logger.getLogger(RubrosControlador.class.getName()).log(Level.SEVERE, null, ex);
            }        
        }
    ...
    public static boolean modificar(Rubros rubro){
        boolean valor = false;
        if (Conexion.conectar()){ 
            String sql = "update rubros set nombre_rubro='" + rubro.getNombre_rubro() + "'"
                    + " where id_rubro=" + rubro.getId_rubro();
